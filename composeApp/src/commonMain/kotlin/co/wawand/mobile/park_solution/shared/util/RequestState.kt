package co.wawand.mobile.park_solution.shared.util
...
fun <T> RequestState<T>.displayResult(
    ...
    transitionScope: ContentTransform? = scaleIn(tween(durationMillis = 400))
    ...
    AnimatedContent(
        ...
        targetState = this,
        transitionSpec = {
            transitionScope ?: (EnterTransition.None togetherWith ExitTransition.None)
        },
